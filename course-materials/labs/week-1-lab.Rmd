---
title: "EDS 222 Week 1 Lab: Summarizing Data in R"
author: "{STUDENT NAME}"
date: "`r Sys.Date()`"
output:
...
source(here("course-materials", "labs", "_common.R"))
...
loans %>% 
  ggplot() +
  geom_bar(aes(x = homeownership, fill = application_type), position = position_dodge())
```
...
loans %>% 
  ggplot() +
  geom_bar(aes(x = homeownership, fill = application_type), position = "fill")
```
