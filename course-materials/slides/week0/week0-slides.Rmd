...
### **Step two:**  Ask a question (also don't need stats)
...
```
<font size="3"> Source: Proctor et al. (Nature, 2018)</font> 
...
Syllabus can always be found on our [course website](https://eds-222-statistics.github.io/).
...
1. My course website is built in git, so you can access any source code you might want (slide materials, lab materials, etc.) from this repo, [#EDS-222-stats](https://github.com/eds-222-statistics/eds-222-statistics.github.io). But you won't ever need to interact with this repo if you don't want to. 

--

2. GitHub Classroom. All homework assignments will be accessed via GH Classroom. You will pull the assignment from GH, edit and push your code by the submission deadline, and then pull again once grades are posted to see your grade and to get feedback.
