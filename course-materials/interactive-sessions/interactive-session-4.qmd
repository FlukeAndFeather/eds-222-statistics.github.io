...
## 1. Learning from existing functions
...
## 3. Getting started - function examples in R & Python
...
## 6. Adding helpful error and warning messages
...
## 7. A few more interesting functions
...
## 8. Testing functions with `{testthat}`
