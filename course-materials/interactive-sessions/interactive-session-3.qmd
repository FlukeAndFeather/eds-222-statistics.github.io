...
## 1. Boolean operator review

In [EDS 212](https://eds-212-essential-math.github.io/), we learned about Boolean operations and logic - the land of TRUE and FALSE. Boolean operations are ubiquitous in scientific programming. Whether looking for string pattern matches, comparing values, or filtering data frames, Boolean operators show up *all* the time - and even if we aren't writing them explicitly, are working behind the scenes. 
...
## 6. Functional programming - some sugar in R
