...
wb_indicators <- read_csv(here("course-materials", "interactive-sessions", "data", "wb_indicators.csv"), na = c("..", ""))

wb_metadata <- read_csv(here("course-materials", "interactive-sessions", "data", "wb_indicators_metadata.csv"))
```
