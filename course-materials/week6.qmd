...
|------------------------|------------------------|------------------------|
| [Logistic regression slides](handouts/week6-handout.pdf){target="_blank"} <br/> [Live coding demo](live-coding/week6/week6-live-coding.qmd) <br/> [Logistic regression slides (annotated)](handouts/week6-handout-annotated.pdf){target="_blank"} | [Logistic regression in R](labs/week-6-lab.Rmd){target="\"_blank"} | Chapter 9 in *IMS* |
